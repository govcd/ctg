"""
Chittagong College (CTG) Multi-Batch Automation Scraper
Website: https://ctgcollege.eshiksabd.com
Credentials: ctgstudent / ctgstudent
...
COLLEGE_CODE = "ctg"
COLLEGE_NAME = "Chittagong College"
FIXED_PREFIX = "120"
ROLL_DIGITS = 4
...
class PortalSession:
    ...
    def authenticate(self):
        ...
        with sync_playwright() as pw:
            ...
            page.locator("input[name=username]").fill("ctgstudent")
            page.locator("input[name=password]").fill("ctgstudent")
